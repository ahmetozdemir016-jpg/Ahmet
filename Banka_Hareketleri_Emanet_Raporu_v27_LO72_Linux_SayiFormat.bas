...
' BANKA HESAP HAREKETLERİ -> EMANET / MİF ANALİZ RAPORU v27 - LibreOffice 7.2 Linux uyumlu
...
' Emanet Türü: Teminat/plaka içeren işlerde 44 Vergi Teminatları; DFIF/D.F.I.F işlerinde 33 Kişilere Ait Diğer Emanetler; diğerlerinde 39 Diğer Çeşitli Emanetler.
...
Sub BankaHareketleriEmanetRaporu()
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v27"
End Sub

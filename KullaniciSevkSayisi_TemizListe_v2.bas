...
'
' Kaynak rapordaki tekrar eden sayfa basliklarini ve ara satirlari atar.
' Su alanlari temiz liste halinde baska sekmeye yazar:
' Sira No, Adi Soyadi, Unvani, Birimi, Evrak Tipi, Sevk Sayisi
...
Sub CALISTIR_KullaniciSevkSayisi_TemizListe()
    ...
    For r = 0 To sonSatir
        ...
        ' Rapor ciktisinda her sayfada baslik tekrar edebildigi icin
        ' her satirda basliklari yeniden ariyoruz.
    ...
    MsgBox _
        ...
        "Aktarılan satır: " & CStr(aktarilan) & Chr(10) & _

...
' BANKA HESAP HAREKETLERİ -> EMANET / MİF ANALİZ RAPORU v21 - LibreOffice 7.2 Linux uyumlu
...
Sub BankaHareketleriEmanetRaporu()
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v21"
End Sub
...
Sub WriteOneRowV2(oOut As Object, outRow As Long, oSrc As Object, srcRow As Long, colTarih As Long, colFis As Long, colTutar As Long, colBakiye As Long, yon As String, belgeSeq As Long, kimlikTipi As String, kimlik As String, gonderen As String, borclu As String, durum As String, hbNo As String, eRef As String, extraRef As String, talimatNo As String, tur As String, banka As String, mif As String, desc As String, emanetTuru As String, plakaNo As String)
    ...
    PutText oOut, 19, outRow, emanetTuru
    PutText oOut, 20, outRow, plakaNo
End Sub
...
Sub WriteSimpleHeaderV2(oOut As Object, rowNo As Long)
    ...
    h = Array("Tarih", "Fiş No", "Belge No", "İşlem Tutarı", "Bakiye", "İşlem Yönü", "T.C. No", "Vergi No", _
              ...
              "MİF Açıklama Önerisi", "Ham Açıklama", "Emanet Türü", "Plaka No")
    For i = 0 To UBound(h)
...
Sub FormatReportV2(oOut As Object, lastOutRow As Long)
    ...
    widths = Array(2600, 2300, 4200, 3000, 3000, 3000, 3600, 3600, 6800, 7600, 4200, 5600, 5600, 3300, 3300, 5200, 6500, 9500, 13000, 6500, 3600)
    For i = 0 To 20
    ...
    If lastOutRow >= 1 Then
        ...
        oOut.getCellRangeByPosition(19, 1, 20, lastOutRow).NumberFormat = GetNumberFormat(ThisComponent, "@")
        On Error GoTo 0
    End If

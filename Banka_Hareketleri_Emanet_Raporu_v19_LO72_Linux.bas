...
' BANKA HESAP HAREKETLERİ -> EMANET / MİF ANALİZ RAPORU v19 - LibreOffice 7.2 Linux uyumlu
' Bu sürümde sadece Emanet_Rapor ve Özet_Rapor oluşturulur; Kimlik No, Ayırma Güveni ve Kontrol Notu sütunları yoktur.
' Belge No: Fiş No'ya bakmadan tarih + sıra numarası ile oluşturulur.
' Örnek: 05.06.2026 tarihli ilk kayıt => 20260605000000000001, ikinci kayıt => 20260605000000000002.
...
Sub BankaHareketleriEmanetRaporu()
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v19"
End Sub
...
Sub WriteOneRowV2(oOut As Object, outRow As Long, oSrc As Object, srcRow As Long, colTarih As Long, colFis As Long, colTutar As Long, colBakiye As Long, yon As String, kimlikTipi As String, kimlik As String, gonderen As String, borclu As String, durum As String, hbNo As String, eRef As String, extraRef As String, talimatNo As String, tur As String, banka As String, mif As String, desc As String)
    ...
    PutText oOut, 2, outRow, BuildSiraliBelgeNo(tarihText, outRow)
...
Function BuildSiraliBelgeNo(tarihText As String, outRow As Long) As String
    ...
    ' Emanet_Rapor veri sırasına göre 1'den başlar ve 12 haneli sıra numarası verir.

...
' BANKA HESAP HAREKETLERİ -> EMANET / MİF ANALİZ RAPORU v22 - LibreOffice 7.2 Linux uyumlu
...
Sub BankaHareketleriEmanetRaporu()
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v23"
End Sub
...
Function GuessEmanetTuru(desc As String) As String
    ...
    ' Teminat/plaka/araç teminatı işlerinde: 44 Vergi Teminatları
    ...
    If InStr(u, "IHALE TEMINAT") > 0 Or InStr(u, "TEMINAT BEDELI") > 0 Or InStr(u, "ARACIN TEMINAT") > 0 Or InStr(u, "PLAKALI") > 0 Or InStr(u, "PLAKA") > 0 Then

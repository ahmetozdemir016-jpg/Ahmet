...
' Belge No: Harf kodlu fişlerde seçili örnek mantığı: YYYYMMDD + 00 + fişin ilk 3 karakteri + son rakam 7 hane. Örnek: FCPD57 => 2026060500FCP0000057
...
Function BuildBelgeNo(tarihText As String, fisText As String) As String
    ...
    ' 1) Harf kodlu fişlerde seçili örnekteki mantık uygulanır:
    '    YYYYMMDD + "00" + Fiş No'nun ilk 3 karakteri + sondaki rakamların 7 haneye tamamlanmış hali
    '    Örnek: 05.06.2026 + FCPD57 => 2026060500FCP0000057
    '    Örnek: 05.06.2026 + FCHC57 => 2026060500FCH0000057
...
Function FisNoIlkUcKod(fisText As String) As String
    ' FCPD57, FCHC57, FDFP43 gibi fişlerde ilk 3 karakteri kod olarak alır: FCP, FCH, FDF.

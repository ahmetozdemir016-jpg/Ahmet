...
Sub BankaHareketleriEmanetRaporu()
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v6"
End Sub
...
Function ExtractTalimatNo(desc As String) As String
    ...
    For i = 1 To Len(rest)
        ch = Mid(rest, i, 1)
        If ch >= "0" And ch <= "9" Then out = out & ch ElseIf out <> "" Then Exit For
    Next i

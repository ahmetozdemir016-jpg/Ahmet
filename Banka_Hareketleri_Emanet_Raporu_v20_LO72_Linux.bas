...
' BANKA HESAP HAREKETLERİ -> EMANET / MİF ANALİZ RAPORU v20 - LibreOffice 7.2 Linux uyumlu
...
Sub BankaHareketleriEmanetRaporu()
    ...
    For r = headerRow + 1 To lastRow
        ...
        If desc <> "" Then
            ...
            WriteOneRowV2 oOut, outRow, oSrc, r, colTarih, colFis, colTutar, colBakiye, yon, belgeSeq, kimlikTipi, kimlik, gonderen, borclu, durum, hbNo, eRef, extraRef, talimatNo, tur, banka, mif, desc
            toplam = toplam + 1
    ...
    MsgBox "Emanet_Rapor ve Özet_Rapor hazırlandı." & Chr(10) & "Giriş: " & girisAdet & " adet" & Chr(10) & "Çıkış/Aktarım: " & cikisAdet & " adet", 64, "Emanet Rapor v20"
End Sub

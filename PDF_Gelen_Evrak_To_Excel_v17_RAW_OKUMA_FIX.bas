...
' ================================================================
'  GELEN EVRAK DEFTERI PDF -> EXCEL - V17 RAW OKUMA FIX
...
'  - V17 farki: PDF -layout ile degil -raw ile okunur; bu PDF'de veriler bu sirada geliyor.
...
' ================================================================
Sub Gelen_Evrak_PDFTEN_Excel_Aktar_V17()
    Gelen_Evrak_PDF_Excel_Aktar_V17
End Sub



' ================================================================
'  V17 - PDF'de sadece Ctrl+A ile secilebilen durumlar icin
'  Kullanim:
'  1) Okular/PDF acik iken Ctrl+A, sonra Ctrl+C yap.
'  2) Calc'a gec, Gelen_Evrak_PANODAN_Excel_Aktar_V17 makrosunu calistir.
...
Sub Gelen_Evrak_PANODAN_Excel_Aktar_V17()
    ...
    ok = GE17_SaveClipboardToFile(sTxt)
    If Not ok Or Not GE17_FileExists(sTxt) Then
    ...
    sOut = GE17_DesktopPath() & "/gelen_evrak_pdfden_mavi_baslik_v17.xlsx"
    GE17_ConvertTextFileToExcel sTxt, sOut
End Sub

Function GE17_SaveClipboardToFile(ByVal sOutTxt As String) As Boolean
    Dim cmd As String
    GE17_SaveClipboardToFile = False
    On Error GoTo EH
    cmd = "if command -v xclip >/dev/null 2>&1; then " & _
          "xclip -selection clipboard -o > " & GE17_ShQ(sOutTxt) & "; " & _
          "elif command -v xsel >/dev/null 2>&1; then " & _
          "xsel -b -o > " & GE17_ShQ(sOutTxt) & "; " & _
          "else exit 127; fi"
    Shell "/bin/sh", 0, "-c " & GE17_Q(cmd), True
    GE17_SaveClipboardToFile = GE17_FileExists(sOutTxt)
    Exit Function
EH:
    GE17_SaveClipboardToFile = False
End Function

Function GE17_FileSize(ByVal sPath As String) As Long
    On Error GoTo EH
    GE17_FileSize = FileLen(sPath)
    Exit Function
EH:
    GE17_FileSize = 0
End Function

Function GE17_DesktopPath() As String
    Dim h As String
    h = Environ("HOME")
    If h = "" Then h = "/tmp"
    If GE17_FolderExists(h & "/Masaüstü") Then
        GE17_DesktopPath = h & "/Masaüstü"
    ElseIf GE17_FolderExists(h & "/Desktop") Then
        GE17_DesktopPath = h & "/Desktop"
    Else
        GE17_DesktopPath = h
    End If
End Function

Function GE17_FolderExists(ByVal sPath As String) As Boolean
    Dim oSFA As Object
    On Error GoTo EH
    oSFA = CreateUnoService("com.sun.star.ucb.SimpleFileAccess")
    GE17_FolderExists = oSFA.exists(ConvertToURL(sPath))
    Exit Function
EH:
    GE17_FolderExists = False
End Function

Function GE17_ShQ(ByVal s As String) As String
    GE17_ShQ = "'" & Replace(s, "'", "'" & Chr(34) & "'" & Chr(34) & "'") & "'"
End Function

Sub Gelen_Evrak_PDF_Excel_Aktar_V17()
...
Sub Gelen_Evrak_TXT_Excel_Aktar_V17()
    Dim sTxt As String, sOut As String
    sTxt = GE17_PickFile("Debug TXT dosyasini sec", "TXT Dosyalari", "*.txt")
    If sTxt = "" Then Exit Sub
    sOut = GE17_MakeOutPath(sTxt)
    GE17_ConvertTextFileToExcel sTxt, sOut
End Sub

Sub GE17_ConvertTextFileToExcel(ByVal sTxt As String, ByVal sOut As String)
...
Function GE17_ParseLinesToSheet(ByRef aLines() As String, ByVal nLines As Long, ByVal oSheet As Object) As Long
...
Sub GE17_ParseRecordLine(ByVal s As String, ByRef evrakNo As String, ByRef geldigiTarih As String, ByRef vergiNo As String, ByRef sameName As String)
...
Sub GE17_ParseGelisLine(ByVal s As String, ByVal nextLine As String, ByRef gelisSekli As String, ByRef resmiTarih As String, ByRef resmiNo As String, ByRef gonderenYer As String, ByRef postaNo As String, ByRef k As Long)
...
Function GE17_IsLikelyOfficialNo(ByVal s As String) As Boolean
...
Function GE17_IsLikelyPostaNo(ByVal s As String) As Boolean
...
Function GE17_IsRecordLine(ByVal s As String) As Boolean
...
Function GE17_IsGelisLine(ByVal s As String) As Boolean
...
Function GE17_IsEvrakTuruLine(ByVal s As String) As Boolean
    Dim n As String
    n = GE17_Norm(GE17_CleanLine(s))
...
Function GE17_IsNoise(ByVal s As String) As Boolean
    Dim n As String
    s = GE17_CleanLine(s)
    n = GE17_Norm(s)
    GE17_IsNoise = False
...
Function GE17_CountRecordCandidates(ByRef aLines() As String, ByVal nLines As Long) As Long
...
Function GE17_ReadLinesUtf8(ByVal sPath As String, ByRef aLines() As String) As Long
...
Sub GE17_WriteHeaders(ByVal oSheet As Object)
...
Sub GE17_FormatSheet(ByVal oSheet As Object, ByVal nRows As Long)
...
Sub GE17_WriteDebugSheet(ByVal oDoc As Object, ByRef aLines() As String, ByVal nLines As Long, ByVal nCand As Long)
...
Sub GE17_SaveAsXlsx(ByVal oDoc As Object, ByVal sOut As String)
...
Function GE17_PickFile(ByVal sTitle As String, ByVal sFilterName As String, ByVal sPattern As String) As String
...
Function GE17_FileExists(ByVal sPath As String) As Boolean
    On Error GoTo EH
...
Function GE17_MakeOutPath(ByVal sInput As String) As String
    Dim p As Long
    ...
    GE17_MakeOutPath = sBaseName & "_gelen_evrak.xlsx"
End Function

Function GE17_LastDot(ByVal s As String) As Long
    Dim i As Long
    GE17_LastDot = 0
...
Function GE17_Q(ByVal s As String) As String
    GE17_Q = Chr(34) & Replace(s, Chr(34), "\" & Chr(34)) & Chr(34)
End Function

Function GE17_JoinTokens(ByVal a As Variant, ByVal firstIndex As Long) As String
...
Function GE17_CleanLine(ByVal s As String) As String
    s = Replace(s, Chr(9), " ")
    s = Replace(s, Chr(10), " ")
    s = Replace(s, Chr(12), " ")
    s = Replace(s, Chr(13), " ")
...
Function GE17_NormalizeSpaces(ByVal s As String) As String
...
Function GE17_Norm(ByVal s As String) As String
    s = GE17_CleanLine(s)
    s = Replace(s, "İ", "I")
    s = Replace(s, "I", "I")
    s = Replace(s, "ı", "i")
...
Function GE17_StartsWithNorm(ByVal s As String, ByVal prefix As String) As Boolean
    GE17_StartsWithNorm = (Left(GE17_Norm(s), Len(prefix)) = prefix)
End Function

Function GE17_IsDigits(ByVal s As String) As Boolean
...
Function GE17_IsDateSlash(ByVal s As String) As Boolean
...
Function GE17_IsDate8(ByVal s As String) As Boolean
    GE17_IsDate8 = False
...
Sub Gelen_Evrak_PDFTEN_Excel_Aktar_V15()
    Gelen_Evrak_PDFTEN_Excel_Aktar_V17
End Sub
